...
export default function JobRequirementsTable(props) {
    ...
    const [getUpdatedJobRequirements, {data: updatedJobRequirements}] = useMutation(UpdateJobRequirement);
    const [deleteJobRequirements, {data: deletedJobRequirements}] = useMutation(DeleteJobRequirement);
